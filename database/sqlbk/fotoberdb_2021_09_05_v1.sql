...
insert  into `payment_detail`(`id`,`order_id`,`payment_id`,`order_name`,`quantity`,`price`,`amount`,`description`,`created_at`,`updated_at`) values (1,2,1,NULL,1,100.00,100.00,'Item 01','2021-09-03 16:38:55','2021-09-03 16:38:57'),(2,2,1,NULL,1,150.00,150.00,'Item 02','2021-09-03 16:38:55','2021-09-03 16:38:57'),(3,2,1,NULL,1,200.00,200.00,'Item 03','2021-09-03 16:38:55','2021-09-03 16:38:57');
...
insert  into `payments`(`id`,`order_id`,`customer_id`,`amount`,`date_request`,`date_success`,`method`,`email_paypal`,`link_payment`,`status`,`created_by`,`created_at`,`updated_at`) values (1,2,1,450.00,NULL,NULL,'PAYPAL',NULL,NULL,0,NULL,'2021-09-03 16:38:15','2021-09-03 16:38:17');
...
CREATE TABLE `requirements` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) DEFAULT NULL COMMENT 'ID của orders',
  `name` varchar(250) DEFAULT NULL COMMENT 'Tên của yêu cầu',
  `description` time DEFAULT NULL COMMENT 'Mô tả chi tiết yêu cầu',
  `status` tinyint(1) DEFAULT NULL COMMENT 'Trạng thái: 0 - new, 1 - pending, 2 - done, 3 - cancel',
  `created_by` int(11) DEFAULT NULL COMMENT 'Người tạo, thường là sale',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
insert  into `users`(`id`,`group_id`,`account_type`,`username`,`salt`,`password`,`fullname`,`birthday`,`address`,`avatar`,`email`,`email_paypal`,`phone`,`gender`,`website`,`email_verified_at`,`notes`,`remember_token`,`is_admin`,`total_order`,`status`,`manager_by`,`last_login`,`last_logout`,`created_at`,`updated_at`,`deleted_at`) values (1,1,'CUSTOMER','customer',NULL,'$2y$10$.eZX1nj4Op9rSMzbIAr9HubgG8onkAsrLrFbG84zUtHHzfM0TwkYC','Johny Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'customer@gmail.com',NULL,NULL,1,NULL,NULL,NULL,'MvLD8AAewXa7aEjiB8TY4GoiSz8YuzKqvZK4ne1QhZCjKEjiel34OPZ9feTF',0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(2,2,'SALE','sale',NULL,'$2y$10$DyszWjBh3AhMl2PEnJLRUOgWdSMerGStdMXTSaVyDcQXDo5b5Kuda','Sale Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'sale@gmail.com',NULL,NULL,1,NULL,NULL,NULL,'usdoCBChanbMqwNo6TlyHK9oU3BTjOqdtpqcK8vqqNz4bpd9OAg0lLfkHZBD',1,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(3,3,'ADMIN','admin',NULL,'$2y$10$Xrv7G5LrUgaWF/lw55qrzOyW9YpjMRn/1PdW9W2XIgEkjkxmmQ0F2','Admin Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'admin@gmail.com',NULL,NULL,1,NULL,NULL,NULL,NULL,0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(4,4,'EDITOR','editor',NULL,'$2y$10$R.zyH7P6WCcRgC/o20F60OmlWuuesfGENtYicj.e6TLG04p9pge8i','Editor Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'editor@gmail.com',NULL,NULL,1,NULL,NULL,NULL,'9k8yY4PmISUwuO1uen1i4M9c8BQL8OrRfjpGDxtSIxUIks5ZpctfhbfR6lxb',0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(5,5,'QAQC','qaqc',NULL,'$2y$10$C66J0tZagPxokDhOCPV3ruzhCLeDwGua48saZH9sDG1t.sTRhn6ye','QAQC Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'qaqc@gmail.com',NULL,NULL,1,NULL,NULL,NULL,NULL,0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(6,6,'SUPER_ADMIN','superadmin',NULL,'$2y$10$t7nR9Z.2WjFr3rBujPJKfe/8coW4dEP0ySRaoxEPBOgamIXZE98cm','SuperAdmin Đặng','1991-09-11','Hà Nội, Việt Nam',NULL,'superadmin@gmail.com',NULL,NULL,1,NULL,NULL,NULL,NULL,0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(8,2,'SALE','doanpv.sale',NULL,'$2y$10$DyszWjBh3AhMl2PEnJLRUOgWdSMerGStdMXTSaVyDcQXDo5b5Kuda','Sale Đoan','1991-09-11','Hà Nội, Việt Nam',NULL,'doanpv.sale@gmail.com',NULL,NULL,1,NULL,NULL,NULL,'ryzM6RHeihJAI90DWYRExcvQYR2FrtEK7zyoV3H4D1Y654wpIk5IjrKN8Sxw',0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL),(9,2,'SALE','minh.sale',NULL,'$2y$10$DyszWjBh3AhMl2PEnJLRUOgWdSMerGStdMXTSaVyDcQXDo5b5Kuda','Sale Minh','1991-09-11','Hà Nội, Việt Nam',NULL,'minh.sale@gmail.com',NULL,NULL,1,NULL,NULL,NULL,'wnBjD3mrU3XFT0JKAJzEz4MgP0t36RAqofMlCM3rTsYy927W9Tokl35Dc8aA',0,0,1,NULL,NULL,NULL,'2021-08-15 12:35:53','2021-08-15 12:35:53',NULL);
