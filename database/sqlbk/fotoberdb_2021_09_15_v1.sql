...
insert  into `requirements`(`id`,`order_id`,`customer_id`,`name`,`description`,`status`,`created_by`,`created_at`,`updated_at`) values (1,7,10,'Biệt thự 2 tầng + 1 tầng trệt','Biệt thự 2 tầng + 1 tầng trệt',1,2,'2021-09-08 22:48:27','2021-09-08 22:48:27');
