                    ...
                    <div class="position-relative" style="clear: both">
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                @if ($corect)
                                <form class="widget-main" method="post" action="{{ route('change_password') }}">
                                    <h4 class="header blue lighter bigger" style="text-align: center">{{ trans('fotober.forgot.header') }}</h4>
                                    ...
                                    <fieldset>
                                        ...
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="password" name="password" class="form-control" placeholder="{{ trans('fotober.account.new_pass') }}">
                                        ...
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="password" name="password_confirmation" class="form-control" placeholder="{{ trans('fotober.account.confirm_new_pass') }}">
                                        ...
                                        <div class="clearfix" style="text-align: center;">
                                            <button type="submit" name="btnLogin" class="width-100 pull-right btn btn-sm btn-primary">{{ trans('fotober.forgot.send') }}</button>
                                        </div>
                                        <div class="space-12"></div>
                                        <!-- Link quyên mật khẩu -->
                                        <!-- Link đăng ký -->
                                        <div class="col-lg-12 col-md-12 col col-sm-12 text-center">
                                            <a href="{{ route('login') }}">{{ trans('fotober.login.title') }}</a>
                                        </div>
                                    </fieldset>
                                </form>
                                @else
                                ...
                                <!--        <i class="ace-icon fa fa-times"></i>-->
                                    ...
                                    {{ trans('fotober.login.the_path_has_expired') }} <a href="{{ route('login') }}">{{ trans('fotober.login.title') }}</a>
                                </div>
                                @endif
                                <!-- /.widget-main -->
                            </div>
