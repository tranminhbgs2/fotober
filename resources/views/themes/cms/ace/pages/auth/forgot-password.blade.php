                    ...
                    <div class="position-relative" style="clear: both">
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <form class="widget-main" method="post" action="{{ route('forgot_password') }}">
                                    ...
                                    <fieldset>
                                        ...
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="email" name="email" class="form-control" placeholder="{{ trans('fotober.login.email') }}">
                                        ...
                                        <div class="clearfix" style="text-align: center;">
                                            <button type="submit" name="btnLogin" class="width-100 pull-right btn btn-sm btn-primary">{{ trans('fotober.forgot.title') }}</button>
                                        </div>
                                        <div class="space-12"></div>
