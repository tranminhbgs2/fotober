                    ...
                    <div class="position-relative" style="clear: both">
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <form class="widget-main" method="post" action="{{ route('login') }}">
                                    <h4 class="header blue lighter bigger" style="text-align: center">{{ trans('fotober.login.header') }}</h4>
                                    ...
                                    <fieldset>
                                        ...
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="email" name="email" class="form-control" placeholder="{{ trans('fotober.login.email') }}" autofocus>
                                        ...
                                        <label class="block clearfix">
                                            <span class="block input-icon input-icon-right">
                                                <input type="password" name="password" class="form-control" placeholder="{{ trans('fotober.login.password') }}">
                                        ...
                                        <div class="col-lg-12 col-md-12 col col-sm-12 text-right">
                                            <a href="{{ route('forgot_password_form') }}">{{ trans('fotober.login.forgot_pass') }}</a>
                                        </div>
                                        <div class="space" style="clear: both"></div>
                                        <!-- Submit -->
                                        <div class="clearfix" style="text-align: center;">
                                            <button type="submit" name="btnLogin" class="width-100 pull-right btn btn-sm btn-primary">{{ trans('fotober.login.title') }}</button>
                                        </div>
                                        <div class="space-12"></div>
                                        <!-- Link quyên mật khẩu -->
                                        <!-- Link đăng ký -->
                                        <div class="col-lg-12 col-md-12 col col-sm-12 text-center">
                                            <a href="{{ route('register_form') }}">{{ trans('fotober.login.register_link') }}</a>
                                        </div>
                                    </fieldset>
                                </form>
                                <!-- /.widget-main -->
