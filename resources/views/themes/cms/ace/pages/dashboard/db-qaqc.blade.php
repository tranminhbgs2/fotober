...
@section('content')
    ...
    {{-- <div class="row" style="margin-top: 25px">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mobile-width-100">
            <h4 style="line-height: 18px">
                {{ trans('fotober.dashboard.title_edited_list') }}
                <span>
                    <a href="{{ route('qaqc_order') }}" style="float: right; font-size: 13px">
    ...
    <div class="row" style="margin-top: 25px">
        <div class="col-lg-12 col-md-12 col-sm-12 mobile-width-100">
            <h4 style="line-height: 18px">
                {{ trans('fotober.dashboard.title_redo_list') }}
                <span>
                    <a href="{{ route('qaqc_order') }}" style="float: right; font-size: 13px">
                        {{ trans('fotober.common.show_all') }}
                    </a>
...
@section('asset-bottom')
    <script type="text/javascript">
        ...
        function getOrderByAjax(url_ajax, page_index) {
            ...
            $.ajax({
                url: '{{ route('dashboard_edited_order_ajax') }}',
                type: 'POST',
                dataType: 'HTML',
                data: data,
                success: function(result) {
            ...
            $.ajax({
                url: '{{ route('dashboard_redo_order_ajax') }}',
                type: 'POST',
                dataType: 'HTML',
                data: data,
                success: function(result) {
