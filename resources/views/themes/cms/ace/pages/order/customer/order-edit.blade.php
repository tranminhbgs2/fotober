...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @if ($order->status > 0 && $order->assigned_sale_id > 0)
                        <div class="alert alert-warning">
                            <button type="button" class="close" data-dismiss="alert">
                        <!--        <i class="ace-icon fa fa-times"></i>-->
                            </button>
                            We are currently processing your order, if there are any changes, please chat directly with sales.
                        </div>
                        <a href="{{ route('customer_order') }}" class="btn btn-primary">Back</a>
                    @else
                        <form class="form-horizontal" role="form" method="post" action="{{ route('customer_order_update') }}" enctype="multipart/form-data">
                             {{-- CSRF --}}
