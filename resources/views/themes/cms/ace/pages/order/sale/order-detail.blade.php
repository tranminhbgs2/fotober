...
<!-- ============================================================== -->
                            ...
                            <table class="table table-bordered mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-info">
                                            @if (isset($order->output) && in_array($order->status, [\App\Helpers\Constants::ORDER_STATUS_EDITED,\App\Helpers\Constants::ORDER_STATUS_CHECKED,\App\Helpers\Constants::ORDER_STATUS_DELIVERING,\App\Helpers\Constants::ORDER_STATUS_COMPLETED, \App\Helpers\Constants::ORDER_STATUS_AWAITING_PAYMENT, \App\Helpers\Constants::ORDER_STATUS_PAID]))
                ...
                <div class="chat-main-box">
                    ...
                    <div class="chat-left-aside">
                        <div class="chat-main-header">
                            <div class="p-3 b-b">
                                @if ($order->customer->fullname)
                                    <h4 class="box-title" style="width: 100%; margin: 0px">
                                    <strong style="line-height: 32px;">{{ trans('fotober.common.staff') }}: {{$order->customer->fullname}}</strong>
                                @else
                                <h4 class="box-title"><strong>Chat Message</strong></h4>
                                @endif
                            </div>
                        ...
                        <div class="chat-rbox" id="chat-content">
                            <ul class="chat-list p-5" id="content-mess-sale-{{$order->id}}">
                        ...
                        <div class="card-body border-top chat-control-abs">
                            ...
                            @else
                                {{-- Không có quyền chat: thêm đoạn giả vào để không lỗi quét id --}}
                                <div class="list-btn-chat" style="display: none">
                                    {{-- <span class="file-group">
                                        <i class="ti-face-smile"></i>
                                    </span> --}}
                                    <span class="d-inline-block">
    ...
    <script src="{{ mix('js/chat.js') }}" async></script>
    <!-- Modal -->
