...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" role="form" method="post" action="{{ route('sale_order_update') }}" enctype="multipart/form-data">
                        {{-- CSRF --}}
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-3 col-lg-2 col-form-label">{{ trans('fotober.order.form_customer') }}</label>
