                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @if ($payment->details)
                                        <tr>
                                            <td class="text-right" colspan="4"><p class="mb-0 font-weight-500">Subtotal</p></td>
                                            <td class="text-right">{{ number_format($subtotal, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="4"><p class="mb-0 font-weight-500">Discount</p></td>
                                            <td class="text-right">{{ number_format(0, 2) }}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-right" colspan="4"><p class="mb-0 font-weight-500">Total</p></td>
                                            <td class="text-right">{{ number_format($subtotal, 2) }}</td>
                                        </tr>
                                    @endif
                                </tbody>
