...
@section('title')
    {{ trans('fotober.sadmin.resoure.title') }}
@endsection
@section('content')
    <script type="text/javascript" src="{{ asset('libs/fckeditor/ckfinder/ckfinder.js') }}"></script>
    <style type="text/css">
    ...
    <div class="CKFinderFrameWindow" style="height: 480px">
        <div id="ckfinder"></div>
